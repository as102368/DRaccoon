    ...
    async with async_playwright() as p:
        ...
        async ({body}) => {
            ...
            const resp = await fetch(url, {
                method: 'POST',
                headers: {'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8', 'Accept': 'application/json, text/plain, */*', 'X-Secsdk-Csrf-Token': 'DOWNGRADE'},
                body,
                credentials: 'include',
            });
